...
export default () => (
  ...
  >
    ...
    >
      <Grid sm={4} item container direction="column" alignItems="flex-start">
        <SearchTweets />
      </Grid>
      <Grid item container sm={2} direction="column" alignItems="center">
        <Grid item style={{ marginTop: 400, marginLeft: 20, marginRight: 20 }}>
          <Typography variant="h6">Drag To Save</Typography>
